$(document).ready(function () {
    var oTable = $('#waste-transportation-table').dataTable({
        "aaSorting": [[0, "asc"]],
        "bProcessing": false,
        "bServerSide": true,
        "bInfo": false,
    ...
    /* 为打开和关闭详细信息添加事件侦听器 */
    $(document).on('click', '#waste-transportation-table tbody td img', function () {
    ...
    $('#waste-transportation-table tbody').on('click', 'button', function () {
        var button = $(this);
